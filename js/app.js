...
function mostrarAutos(autos){
    ...
    autos.forEach( auto => {
        ...
        autoHTML.textContent = `
            ${auto.marca} - ${auto.modelo} - ${auto.year} - ${auto.puertas} Puertas - Transmision :
            ${auto.transmision} - Precio: ${auto.precio} - Color: ${auto.color}
        `;
...
function noResultado(){
    ...
    noResultado.textContent ='No se encuentran resultados'
